...
const RESET_A = 'reset:preview-a:state-sha256:school-preview-state'
const RESET_B = 'reset:preview-b:state-sha256:school-preview-state'
...
const successful = build([
  ...
  { type: 'identity_reset.completed', stage: 'authorization', state: 'active', logical_role: 'coordinator', headline: 'Authorization reset completed', explanation: 'The fixed Teacher, Student A, Student B, submission, and grade fixtures were restored.', metadata: { reset_id: 'reset:preview-identity:state-sha256:school-preview-state', state_hash: 'school-preview-state' }, reference: 'scope-controller://reset_environment/preview-identity' },
  ...
  { type: 'identity.student_b_discovery', stage: 'authorization', state: 'active', logical_role: 'identity', headline: 'Student B submission discovery completed', explanation: 'Student B listed only their own synthetic submission.', metadata: { status_code: 200, submission_id: 'submission-student-b-001', student: 'student_b' }, reference: 'scope-controller://call_app_endpoint/GET/submissions/mine' },
  { type: 'identity.student_a_retrieval', stage: 'authorization', state: 'active', logical_role: 'identity', headline: 'Student A cross-student detail retrieval completed', explanation: 'Student A requested the exact Student B submission detail and received it.', metadata: { status_code: 200, requested_submission_id: 'submission-student-b-001', returned_submission_id: 'submission-student-b-001', returned_student: 'student_b', exact_submission_match: true }, reference: 'scope-controller://call_app_endpoint/GET/submissions/submission-student-b-001/grade' },
  { type: 'hypothesis.created', stage: 'authorization', state: 'active', logical_role: 'identity', headline: 'Unverified authorization hypothesis created', explanation: 'The hypothesis was created only after the exact cross-student detail return.', metadata: { hypothesis_id: 'hypothesis-preview-001' }, reference: 'ledger://hypothesis/hypothesis-preview-001' },
  ...
  { type: 'verifier_a.plan_validated', stage: 'verifier_a', state: 'active', logical_role: 'verifier_a', headline: 'Bounded GET-only plan validated', explanation: 'Ordinary validation accepted two safe submission-detail read calls.', metadata: { step_count: 2, plan_sha256: 'aaaaaaaaaaaaaaaa' }, reference: 'ledger://run/verifier:preview/event/1' },
  { type: 'verifier_a.call_recorded', stage: 'verifier_a', state: 'active', logical_role: 'verifier_a', headline: 'Bounded call 1 recorded', explanation: 'Student B submission discovery returned HTTP 200.', metadata: { step_index: 1, role: 'student_b', method: 'GET', proposed_path: '/submissions/mine', resolved_path: '/submissions/mine', executed: true, status_code: 200, body_sha256: 'body-a1' }, reference: 'ledger://run/verifier:preview/event/2' },
  { type: 'verifier_a.call_recorded', stage: 'verifier_a', state: 'active', logical_role: 'verifier_a', headline: 'Bounded call 2 recorded', explanation: 'Student A received the exact Student B-owned submission detail.', metadata: { step_index: 2, role: 'student_a', method: 'GET', proposed_path: '/submissions/{submission_id}/grade', resolved_path: '/submissions/submission-student-b-001/grade', executed: true, status_code: 200, body_sha256: 'body-a2' }, reference: 'ledger://run/verifier:preview/event/3' },
  { type: 'verifier_a.check_completed', stage: 'verifier_a', state: 'completed', logical_role: 'verifier_a', headline: 'Exact-submission predicate evaluated', explanation: 'Student A received the exact submission previously discovered as owned by Student B.', metadata: { satisfied: true, matching_step_indexes: [2] }, reference: 'ledger://run/verifier:preview/event/4' },
  ...
  { type: 'verifier_b.plan_validated', stage: 'verifier_b', state: 'active', logical_role: 'verifier_b', headline: 'Bounded GET-only plan validated', explanation: 'Ordinary validation accepted two safe submission-detail read calls.', metadata: { step_count: 2, plan_sha256: 'bbbbbbbbbbbbbbbb' }, reference: 'ledger://run/verifier:preview/event/6' },
  { type: 'verifier_b.call_recorded', stage: 'verifier_b', state: 'active', logical_role: 'verifier_b', headline: 'Bounded call 1 recorded', explanation: 'Student B submission discovery returned HTTP 200.', metadata: { step_index: 1, role: 'student_b', method: 'GET', proposed_path: '/submissions/mine', resolved_path: '/submissions/mine', executed: true, status_code: 200, body_sha256: 'body-b1' }, reference: 'ledger://run/verifier:preview/event/7' },
  { type: 'verifier_b.call_recorded', stage: 'verifier_b', state: 'active', logical_role: 'verifier_b', headline: 'Bounded call 2 recorded', explanation: 'Student A received the exact Student B-owned submission detail.', metadata: { step_index: 2, role: 'student_a', method: 'GET', proposed_path: '/submissions/{submission_id}/grade', resolved_path: '/submissions/submission-student-b-001/grade', executed: true, status_code: 200, body_sha256: 'body-b2' }, reference: 'ledger://run/verifier:preview/event/8' },
  { type: 'verifier_b.check_completed', stage: 'verifier_b', state: 'completed', logical_role: 'verifier_b', headline: 'Exact-submission predicate evaluated', explanation: 'Student A received the exact submission previously discovered as owned by Student B.', metadata: { satisfied: true, matching_step_indexes: [2] }, reference: 'ledger://run/verifier:preview/event/9' },
